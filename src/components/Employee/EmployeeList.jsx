...
const rows = [
    createData(1, 'Mg Mg', 'Mandalay-TadaOo', '09-98765432', 'Mandalay'),
    createData(2, 'Mg Mg', 'Mandalay-TadaOo', '09-98765432', 'Mandalay'),
    createData(3, 'Mg Mg', 'Mandalay-TadaOo', '09-98765432', 'Mandalay'),
    createData(4, 'Mg Mg', 'Mandalay-TadaOo', '09-98765432', 'Mandalay'),
    createData(5, 'Mg Mg', 'Mandalay-TadaOo', '09-98765432', 'Mandalay'),
    createData(6, 'Mg Mg', 'Mandalay-TadaOo', '09-98765432', 'Mandalay'),
    ...
    return (
        <>
            ...
            >
                ...
                <Box m={2}>
                    <Box mt={2}>
                        <Typography variant="h6" color="#094708" ml={2} mb={1} mt={0}> {t("employee.title")}
                        </Typography>
                    </Box>
